...
export default function Counter(){
    return(
        <Container className="flex justify-center w-full">
            <Wrapper className="flex flex-col lg:flex-row items-center justify-center w-full lg:mx-24 lg:my-16">
                <Left className="w-full lg:w-1/2">
                    <CounterContainer className="flex flex-col justify-center text-center lg:text-left bg-red h-72 w-full py-3 lg:py-9 px-5 lg:px-14">
                        <TitleText className="text-white text-center lg:text-left text-4xl font-semibold font-textfond my-2">
                    ...
                    <DescriptionWrapper className="w-full px-5 py-5 lg:pt-9 lg:pb-0 lg:px-14 font-textfont text-xl">
                ...
                <Right className="w-full lg:w-1/2">
                    <ArtWrapper>
