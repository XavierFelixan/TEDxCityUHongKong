...
export default function Counter(){
    return(
        <Container className="flex justify-center w-full">
            <Wrapper className="flex flex-col md:flex-row items-center justify-center w-full my-5">
                <Left className="w-full md:w-1/2">
                    <CounterContainer className="flex flex-col justify-center text-center md:text-left bg-red h-72 w-full py-3 md:py-9 px-5 md:px-14">
                        <TitleText className="text-white text-center md:text-left text-4xl font-semibold font-textfond my-2">
                    ...
                    <DescriptionWrapper className="w-full px-5 py-5 md:py-9 md:px-14 font-textfont text-xl">
