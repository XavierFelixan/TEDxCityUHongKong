    ...
    return(
        <Container className="flex justify-center w-[100%] font-textfond">
            <ContentWrapper className="flex flex-col justify-center">
                <TedxdescWrapper className="flex justify-center mx-5 lg:mx-20 text-lg">
                    <Tedxdesc className="my-5 lg:my-12">
                        ...
                        <div className="font-bold text-2xl lg:text-3xl mt-7 mb-5">
